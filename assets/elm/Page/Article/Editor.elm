...
import Elm.Data.Session as Se exposing (Session)
...
type Msg
    ...
    | SetTags String
    | SetBody String
    | CreateCompleted (Result Http.Error Article)
    | EditCompleted (Result Http.Error Article)
            ...
            case validate modelValidator model of
                [] ->
                    case model.editingArticle of
                        Nothing ->
                            model => RequestArticle.create model user
